...
M.base = {
    ...
    CursorLineNr = { fg = colors.orange, bg = colors.gutter_bg, style = "bold" },
    ...
    CurSearch = { fg = colors.black, bg = colors.boolean },
    IncSearch = { fg = colors.black, bg = colors.green },
    ...
    StatusLineNC = { fg = colors.dark, bg = colors.bg },
    ...
    Visual = { fg = "NONE", bg = colors.line_fg, style = "bold" },
...
M.plugins = {
    ...
    -- Cybu
    -----------------------------------------
    CybuAdjacent = { fg = colors.black, bg = colors.pink },
    ...
    --   Debug:
    -----------------------------------------
    DapStopped = { fg = colors.red_err },
    DapBreakpoint = { fg = colors.red_err },
    DapBreakpointCondition = { fg = colors.red_err },
    DapLogPoint = { fg = colors.red_err },
    ...
    RainbowDelimiterYellow = { fg = colors.red_key_w },
    RainbowDelimiterBlue = { fg = colors.blue_type },
    RainbowDelimiterOrange = { fg = colors.orange },
    RainbowDelimiterGreen = { fg = colors.green },
    RainbowDelimiterViolet = { fg = colors.red_key_w },
    RainbowDelimiterCyan = { fg = colors.diff_text },
    -----------------------------------------
